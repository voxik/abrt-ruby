...
or if you're using Bundler, write following line into your Gemfile
...
Now, everytime the unhandled exception is captured, ABRT handler prepares bugreport, which can be later submitted using standard ABRT tools.
