...
Now, everytime the unhandled exception is captured, ABRT handler prepares bugreport, which can be submitted into bugzilla.redhat.com component later using standard ABRT tools.
